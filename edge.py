...
# Baris 22: Ganti path ini dengan lokasi file Anda (misal: 'kucing.jpeg')
image = img.imread('C:/Users/sitif/Downloads/kucing.jpeg', mode='F')
...
for y in range(1, imgPad.shape[0]-1):
    for x in range(1, imgPad.shape[1]-1):
        ...
        Gx[y, x] = np.sum(area * sobelX)
        Gy[y, x] = np.sum(area * sobelY)
